...
{ name: "Fuel Deposit", nameJP: "燃料鉱床", sprite: 23, tier: 2, category: 7, invulnerable: true, resourceSupply: [0, 0, 0, 4], description: "What's that smell? Poof! Aluminum and sulfur deposits--or aluminium and sulphur if you like extra letters--provide the base we need for most of our explosive demands.", descriptionJP: "何か臭くない？フッ！鉱床に潜むアルミと硫黄、または（文字の多いほうが好きならば）アルミニウムと硫黄が、私達が必要な爆発物の大部分の基礎になる。" },
